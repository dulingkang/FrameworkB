...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/dulingkang@163.com/FrameworkB'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'dulingkang@163.com' => 'dulingkang@163.com' }
  s.source           = { :git => 'https://github.com/dulingkang@163.com/FrameworkB.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'FrameworkB' => ['FrameworkB/Assets/*.png']
  # }
